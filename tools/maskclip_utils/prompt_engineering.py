...
hk_classes = ['french toast', 'pineapple bun', 'egg tart'] + bg_classes
...
def parse_args():
    ...
    parser.add_argument('--class-set', default=['voc'], nargs='+',
        choices=['city', 'ade', 'stuff', 'voc', 'context', 'acontext', 'mickey', 'batman', 'mario', 'gates', 'hk', 'blur', 'sports', 'car_brands', 'batman_ext', 'car_color'],
